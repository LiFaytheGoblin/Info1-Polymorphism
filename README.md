...
Download the [https://github.com/LiFaytheGoblin/Info1-Polymorphism/blob/main/Exercise2_Class_Diagram.png](UML class diagram) and either upload it into a miro board for collaborative editing or put it into an image editing software of your choice. This diagram represents the relationship between different types of cups and liquids.
